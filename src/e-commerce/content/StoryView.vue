<template>
  <div class="story-view fixed top-0 w-full">
    <div class="story-view bg-white flex h-screen">
      ...
      <div
        class="story-sidebar w-1/5 lg:h-5/6 md:2/3 border-gray-400 border-r bg-white hidden lg:block"
      >
        <div class="flex justify-start items-center">
          <router-link to="/user-dashboard">
            <button
              class="rounded-full h-10 w-10 flex items-center justify-center bg-gray-400 ml-4 mt-5"
            >
              <font-awesome-icon
        ...
        <div class="flex items-center justify-start mt-4">
          <router-link to="/user/me/add-story">
            <button
              class="rounded-full h-16 w-16 flex items-center justify-center ml-4 bg-gray-200"
            >
              <font-awesome-icon
        ...
        <ul class="ml-4 story-items h-full mb-24">
          ...
          >
            <div
              ...
              :class="
                currentItemId === index ? 'border-gray-300' : 'border-blue-600'
              "
            >
              <img
                :src="story.userPhoto"
